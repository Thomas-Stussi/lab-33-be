module.exports = [
  {
    name: 'Tart de Bry',
    ingredients: '1 pound of Brie cheese, the younger the better, 6 egg yolks, ⅛ tsp saffron (about 10 threads ground up), ¾ tsp light brown sugar or more if you want a sweeter tart, ⅜ teaspoon powdered ginger, A pinch of salt, A sprinkle of nutmeg or cinnamon (optional)',
    directions: `1. Preheat the oven to 425°F / 220°C.
    ...
    date: 'England, 14th Century'
  },
  {
    name: 'Pomodori Farcini all\'Erbette',
    ingredients: 'Fresh ripe tomatoes (medium size), Italian Parsley, Onion, Sorrel (or another sour/bitter green such as arugula or chard), Mint, Prosciutto, Egg Yolks (about 1 for every 2 tomatoes), Provatura (or fresh mozzarella), Salt & Pepper, Olive Oil for frying',
    directions: `1. Mince the herbs and onion and mix together in a medium bowl. 
    ...
    source: 'Il Cuoco Galante by Vincenzo Corrado',
    date: 'Italy, 1773'
  },
  {
    name: 'Thirty-Second Regiment or Victoria Punch',
    ingredients: '6 lemons, in slices, ½ gallon of brandy, ½ do. Jamaica rum, 1 lb of White Sugar, 1 ¾ quart of water, 1 pint of boiling milk',
    directions: `Steep the lemons for twenty-four hours in the brandy and rum; add the sugar, water and milk, and when well mixed, strain through a jelly-bag.
    ...
    source: 'The Bon-Vivant\'s Companion by Jerry Thomas',
    date: 'USA, 1862'
  }
];
